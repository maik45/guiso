<!-- <div class="row">
  <div class="col-xs-12">
      <h3 class="page-header text-blue">Creación de Orden de Compra</h3>
  </div>
</div>
 -->
  ...
  <div class="col-xs-12">
    ...
    <div class="panel panel-default">
      <div class="panel-heading bg-coral text-white">
        Creación de Ordenes de Compra por Cliente
      </div>
        ...
        <form action="#" method="post" name="form_excedente" id="form_excedente">
            ...
            <div class="row my-1">
                ...
                <div class="col-xs-12 text-center">
                    <button type="submit" class="btn btn-primary"> <i class="fa fa-file-excel-o"></i> Orden de Compra Sin Presentación</button>
                </div>
...
(function(){
  ...
  form_excedente.addEventListener('submit', function(ev){
    ...
    Swal.fire({
        ...
        text: `¿Desea crear la orden de compra de ${this.cliente.options[this.cliente.selectedIndex].text}?`,
        icon: 'question',
  ...
  var generarOrden = data =>{
    ...
    form.target = '_blank';
    form.action = 'OC/generaOrden.php';
    form.method = 'post';
