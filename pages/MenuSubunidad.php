...
<div id="panel-1-contenedor" class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs">
            <li>
                <a data-toggle="tab" data-texto="Menú subunidades: Agregar" data-archivo="RegistrarSubnidad.php" data-botones="Limpiar-formulario:limpiarForm() Registrar:registrarPrecio()" data-contexto="registrar">Registrar</a>
            </li>
            <li>
            ...
            <li>
                <a data-toggle="tab" data-texto="Menú subunidades: Modificar" data-archivo="Modificar.php" data-botones="Cancelar-cambios:cancelar() Guardar-cambios:guardarCambiosPrecio()" data-contexto="modificar">Modificar</a>
            </li>
            <li>
