    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <label data-texto="* Clave del grupo"></label>
                <input class="form-control" name="idGrupo" value="" required="true" type="text" autofocus="true" maxlength="3" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 || event.keyCode === 13 || event.keyCode === 9 ? true : !isNaN(Number(event.key))">
...
<script type="text/javascript">
    $("[name='idGrupo']").on({change : esClave});
