...
<div id="panel-1-contenedor" class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs">
            <li>
                <a data-toggle="tab" data-texto="Menú unidad: Registrar" data-archivo="RegistrarUnidad.php" data-botones="Limpiar-formulario:limpiarForm() Registrar:registrar()"data-contexto="registrar">Registrar</a>
            </li>
            <li>
            ...
            <li>
                <a data-toggle="tab" data-texto="Menú unidad: Modificar" data-archivo="Modificar.php" data-botones="Cancelar-cambios:cancelar() Guardar-cambios:guardarCambiosPrecio()" data-contexto="modificar">Modificar</a>
            </li>
            <li>
